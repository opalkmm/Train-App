  ...
  db.on("child_added", function(childsnapshot) {
    ...
    $("#trainschedule tr:last").after('<tr class="table-active"><td>'+tName+'</td><td>'+tDestination+'</td><td>'+tFrequency+'</td><td>'+nextArrival+'</td><td>'+tRemainder+'</td></tr>');
